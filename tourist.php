  ...
  <div class="container">
      ...
      <button type="button" class="btn btn-success " style="width:120px;margin-left:20px" ><a href="tourist.php" style="color:white; font-size:12px;" style="color:white; font-size:12px;"> Tourist Dream</a></button> 
        <br> 
          ...
          <div id="gamearea" style="width:950px; height:1300px; background-color:ed; float:right; border-left:2px solid grey;padding-left:50px; ">
          ...
          <h2 style="margin-left:0px;font-family:helvetica; color:rgb(00,00,8b)"> Tourist Dream</h4>
          <br>
          
            <?php
                $file = fopen("4/prob.txt", "r");
                       $i = 0;
                            while (!feof($file)) {
            ...
            <h4 style="margin-left:0px; font-family:helvetica; color:red"> Input Files : </h4>
                 <a href="4/inp1.txt" download>Input 1</a><br />
                 <a href="4/inp2.txt" download>Input 2</a><br />
                 <a href="4/inp3.txt" download>Input 3</a><br />
                 <a href="4/inp4.txt" download>Input 4</a><br />
                 <a href="4/inp5.txt" download>Input 5</a><br />
                 
            <h4 style="margin-left:0px; font-family:helvetica; color:red"> Enter Output : </h4>
     <form role="form" action="check4.php" method="post" enctype="multipart/form-data">
