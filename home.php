...
<nav class="navbar navbar-default navbar-fixed-top" style="min-height:50px">
  ...
  <div class="container">
    ...
    <div id="gamearea" style="width:950px;height:500px;background-color:re;float:right;border-left:2px solid grey ">
          <h1 style="margin-left:20px;font-size:50px;margin-top:0;font-family:helvetica">Welcome to Online Judge</h1>
          <h4 style="margin-left:20px;font-family:helvetica"> Please Choose From Question to Proceed.</h2>
