...
<html lang="en">
<head>
  <title>Pallindromic Substring</title>
  <style>
   .panel-heading{
    font-size:17px;
   }
  ...
  <div class="container">
      ...
      <button type="button" class="btn btn-success " style="width:120px;margin-left:20px" ><a href="tourist.php" style="color:white; font-size:12px;" style="color:white; font-size:12px;"> Tourist Dream</a></button> 
        <br> 
          ...
          <div id="gamearea" style="width:950px; height:1200px; background-color:ed; float:right; border-left:2px solid grey;padding-left:50px; ">
          ...
          <h2 style="margin-left:0px;font-family:helvetica; color:rgb(00,00,8b)"> Pallindromic Substring</h4>
          <br>
          
            <?php
                $file = fopen("2/prob.txt", "r");
                       $i = 0;
                            while (!feof($file)) {
            ...
            <h4 style="margin-left:0px; font-family:helvetica; color:red"> Input Files : </h4>
                 <a href="2/inp1.txt" download>Input 1</a><br />
                 <a href="2/inp2.txt" download>Input 2</a><br />
                 <a href="2/inp3.txt" download>Input 3</a><br />
                 <a href="2/inp4.txt" download>Input 4</a><br />
                 <a href="2/inp5.txt" download>Input 5</a><br />
                 
            <h4 style="margin-left:0px; font-family:helvetica; color:red"> Enter Output : </h4>
            <form role="form" action="check2.php" method="post">
