...
<nav class="navbar navbar-default navbar-fixed-top" style="min-height:50px">
  ...
  <div class="container">
      ...
      <p style="font-size:13px">Choose Question</p>
          ...
          <button type="button" class="btn btn-success" style="width:120px; margin-left:20px; color:white" ><a href="morning.php" style="color:white; font-size:12px;" id="active"> Morning Assembly</a></button>  
           <br>
            <br>
           ...
           <br>
            <br>
           <button type="button" class="btn btn-success " style="width:120px;margin-left:20px" ><a href="salary.php" style="color:white; font-size:12px;" > Salary Survey</a></button> 
           <br> 
            <br>
      <button type="button" class="btn btn-success " style="width:120px;margin-left:20px" ><a href="tourist.php" style="color:white; font-size:12px;" style="color:white; font-size:12px;"> Tourist Dream</a></button> 
        <br> 
          ...
          <div id="gamearea" style="width:950px; height:1650px; background-color:ed; float:right; border-left:2px solid grey;padding-left:50px; ">
          ...
          <h2 style="margin-left:0px;font-family:helvetica; color:rgb(00,00,8b)"> Morning Assembly</h4>
          <br>
          
            <?php
                $file = fopen("1/prob.txt", "r");
                       $i = 0;
                            while (!feof($file)) {
                ...
                $file = fopen("1/sOutput.txt", "r");
                       $i = 0;
                         ...
                         echo $line_of_text."<br />";
                              ...
                              fclose($file);
            ?>
             <h4 style="margin-left:0px; font-family:helvetica; color:red"> Explaination (For First Test Case ): </h4>
             <?php
                $file = fopen("1/explaination.txt", "r");
                       $i = 0;
                            while (!feof($file)) {
            ...
            <h4 style="margin-left:0px; font-family:helvetica; color:red"> Input Files : </h4>
                 <a href="1/inp1.txt" download>Input 1</a><br />
                 <a href="1/inp2.txt" download>Input 2</a><br />
                 <a href="1/inp3.txt" download>Input 3</a><br />
                 <a href="1/inp4.txt" download>Input 4</a><br />
                 <a href="1/inp5.txt" download>Input 5</a><br />
                 <a href="1/inp6.txt" download>Input 6</a><br />
            <h4 style="margin-left:0px; font-family:helvetica; color:red"> Enter Output : </h4>
            <form role="form" action="check1.php.php" method="post">
